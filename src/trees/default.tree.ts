...
class DefaultTree {
    ...
    private map_children_data_to_head (parentSVGEl?: any, parentId?: string): TChildrenMapperReturnEl {
        ...
        childElContainer.className = "ts-head-wrapper child-container";
    ...
    private handleCollapseChildren (svgNode: any, id: string, clicked_pos: number) {
        ...
        if (!nodeAncestor?.hasAttribute('data-ts-head-children-hidden') && nodeAncestor.querySelector('.child-container').innerHTML == '') {
